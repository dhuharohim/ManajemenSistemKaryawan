...
<form enctype="multipart/form-data" action="{{ route('employment-user.store') }}" method="post">
    ...
    <div class="row">
        ...
        <div class="col">
            <div class="card shadow mb-3">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="tel" name="phone" id="phone" placeholder="0822 9011 758" pattern="[0-9]{4} [0-9]{4} [0-9]{3}" maxlength="13"  class="form-control" required/> 
                        <br>
                        ...
                        <select name="sub" required>
                            <option value="1">Grogol Utara</option>
                            <option value="2">Grogol Selatan</option>
                            <option value="3">Grogol Barat</option>
                            <option value="4">Grogol Timur</option>
                        </select>
                        <br><br>  
                        <label class="font-weight-bold">ZIP Code</label><br>
                        <input type="text" name="zip" id="zip" class="form-control" placeholder="input ZIP" required><br>
            ...
            <button type="submit" class="btn btn btn-primary btn-lg float-right">Submit</button>
        </div>
