            ...
            <div class="card shadow mb-3">
                <div class="card-body">                        
                    <div class="form-group">
                        ...
                        <input value="{{ $data->eid }}" type="text" name="eid" id="eid" class="form-control" placeholder="input employment-id" required> 
                        <label class="font-weight-bold mt-3">Email</label>
                        <input value="{{ $data->email }}" type="text" name="email" id="email" class="form-control" placeholder="input email" required> 
                        <label class="font-weight-bold mt-3">Alternate Email</label>
                        <input value="{{ $data->alt_email }}" type="text" name="alt_email" id="alt-email" class="form-control" placeholder="input alternate email"> 
                        <label class="font-weight-bold mt-3">Join Date</label>
                        <input value="{{ $data->join }}"type="date" name="join" id="join" class="form-control" placeholder="input join date" required>
                        ...
                        <input value="{{ $data->payment }}" type="text" name="payment" id="payment" class="form-control" placeholder="input payment" required>
                        <br>
                        ...
                        <input value="{{ $data->alt_date }}" type="date" name="alt_date" id="alt_date" class="form-control" placeholder="input alternate date" required>
                        <br>
            ...
            <div class="card shadow mb-3">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input value="{{ $data->name }}" type="text" name="name" id="name" class="form-control" placeholder="input full name" required><br>
                        <label class="font-weight-bold">ID(NIK)</label>
                        <input value="{{ $data->id_nik }}" type="text" name="id_nik" id="id_nik" class="form-control" placeholder="input ID(NIK)" required><br>
                        <label class="font-weight-bold">Birthplace</label>
                        <input value="{{ $data->birthplace }}" type="text" name="birthplace" id="birthplace" class="form-control" placeholder="input birthplace" required> <br>
                        <label class="font-weight-bold">Birtdate</label>
                        <input value="{{ $data->birthdate }}" type="date" name="birthdate" id="birthdate" class="form-control" required>
                        <br>
                        ...
                        <input value="{{ $data->phone }}" type="tel" name="phone" id="phone" placeholder="081 236 7891" pattern="[0-9]{3} [0-9]{3} [0-9]{4}" maxlength="12"  class="form-control" required/> 
                        <br>
                        ...
                        <input value="{{ $data->address }}" type="text" name="address" id="address" class="form-control" placeholder="input address" required><br>
                        <label class="font-weight-bold">NPWP</label>
                        <input value="{{ $data->npwp }}" type="text" name="npwp" id="npwp" class="form-control" placeholder="input npwp" required><br>
                        <label class="font-weight-bold">Marriage Status</label>
                        <input value="{{ $data->marriage }}" type="text" name="marriage" id="marriage" class="form-control" placeholder="input marriage status" required><br>
