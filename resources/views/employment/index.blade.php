...
@section('title', 'Employment(Admin)')
@section('heading', 'Employment(Admin)')

@section('main-content')
    <div class="mb-3">
        <div id="customer-table" class="mb-3">
            <a href="{{ route('employment-form.upload') }}" class="btn btn-primary mb-3">Upload Data</a>
            <div class="card">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center; vertical-align:middle;">
                                                ...
                                                <a class="btn btn-success"
                                                    href="{{ route('employment-form.edit', ['eid' => $datas->eid]) }}">Update</a>
                                                <a onclick="return  confirm('are you sure?')" class="btn btn-danger"
                                                    href="{{ route('employment-form.delete', ['eid' => $datas->eid]) }}">Delete</a>
                                                <a class="btn btn-info"
                                                    href="{{ route('employment-form.info', ['eid' => $datas->eid]) }}">Info</a>
                                    </td>
